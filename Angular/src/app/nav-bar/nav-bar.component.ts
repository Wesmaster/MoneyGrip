...
import { faPercentage, faExchangeAlt, faCaretUp, faCaretDown, faChartLine, faBars, faSignInAlt, faSignOutAlt, faFileInvoice, faAlignLeft, faFileContract, faCalendarAlt, faPiggyBank, faEdit, faBookmark, faTag, faUsers, faCogs, faDatabase, faQuestionCircle, faBook, faInfoCircle, faMoneyCheck } from '@fortawesome/free-solid-svg-icons';
